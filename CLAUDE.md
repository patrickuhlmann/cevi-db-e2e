...
* Der globale Playwright-Timeout ist 15s. Tests mit mehreren Phasen (Erstellen → externe Anmeldung → Cleanup) brauchen einen Test-Level-Timeout: `test.setTimeout(60000)` am Anfang des Testbodys setzen.
